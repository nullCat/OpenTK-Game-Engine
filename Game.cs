...
namespace GameEngine2
{
    class Game : GameWindow
    {
        ...
        private int vertexBufferHandle; //save vertex data into graphic card.
        ...
        protected override void OnLoad()
        {
            ...
            //everything write after vertexarrayhandle will be encapsulated
            GL.BindBuffer(BufferTarget.ArrayBuffer, this.vertexBufferHandle);
        ...
        {
            //set a color after remove all colors in background
